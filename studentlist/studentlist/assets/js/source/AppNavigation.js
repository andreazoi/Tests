! function (n, e) {
    ...
    a.MENU_MAXIMIZED = 1, a.MENU_COLLAPSED = 2, a.MENU_HIDDEN = 3, i._lastOpened = null, i.initialize = function () {
        ...
        var i = e(n.currentTarget),
            t = i.find("> ul"),
            l = i.closest("ul");
        (this._handleMenubarEnter(i), 0 !== t.children().length) && (this._closeSubMenu(l), (this.getMenuState() === a.MENU_COLLAPSED || !1 === i.hasClass("expanded")) && this._openSubMenu(i))
    }, i._handleMenubarEnter = function (n) {
        var a = this,
            i = e("body").hasClass("offcanvas-left-expanded"),
            t = e("#menubar").data("expanded"),
            l = void 0 !== n;
        if ((!0 === l || !1 === i) && !0 !== t && (e("#content").one("mouseover", function (n) {
            a._handleMenubarLeave()
        }), e("body").addClass("menubar-visible"), e("#menubar").data("expanded", !0), e("#menubar").triggerHandler("enter"), !1 === l))
            if (this._lastOpened) {
                a = this;
        ...
        return null === i ? e("#menubar").width() <= 100 ? a.MENU_COLLAPSED : a.MENU_MAXIMIZED : "0" === i[4] ? a.MENU_MAXIMIZED : a.MENU_HIDDEN
        ...
        if (e.isFunction(e.fn.nanoScroller)) {
            ...
            if (0 !== a.length) {
                ...
                !1 === i.parent().hasClass("nano-content") && i.wrap('<div class="nano"><div class="nano-content"></div></div>');
                var t = e(window).height() - a.position().top - a.find(".nano").position().top,
                    l = i.closest(".nano");
                l.css({
                    height: t
                }), l.nanoScroller({
