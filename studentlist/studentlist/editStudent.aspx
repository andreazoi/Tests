<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="editStudent.aspx.cs" Inherits="studentlist.editStudent" %>
...
<div class="form-horizontal">
			...
			<div class="input-group">
                      ...
                      <asp:TextBox ID="TextBoxstudentCode"  ReadOnly="true"  ViewStateMode="Enabled" placeholder="like ST001" EnableViewState="true"  CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                    ...
                    <asp:Button ID="Button1" class="btn btn-default" OnClick="Button1_Click" runat="server" Text="Update" />
